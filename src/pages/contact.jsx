    ...
    <Layout>
      <section className="flex mt-24 md:mt-32 min-h-full mb-2 md:mb-24 justify-center items-center">
        <div className="flex flex-col space-y-6  w-full max-w-6xl p-8 md:flex-row md:space-x-6 md:space-y-0">
          <div className="flex flex-col justify-between space-y-8 sm:p-12">
            ...
            <div>
              ...
              <p className="pt-2 text-sm">
                ...
                dolor ipsa at laudantium nesciunt eaque eos autem voluptates
                fugiat et!
              </p>
            </div>
          ...
          <div>
            <div className="bg-white shadow-lg rounded-xl p-8 text-gray-600 h-full">
              <form
                ...
                action=""
                className="flex flex-col space-y-4 text-sm md:w-80"
              >
                {/* name input */}
                <div>
                  <input
                    ...
                    {...register('name')}
                  ></input>
                  <span className='pl-3 text-red-500'>{errors.name?.message}</span>
                </div>
                {/* business input */}
                <div>
                  <input
                    ...
                    {...register('business')}
                  ></input>
                  <span className='pl-3 text-red-500'>{errors.business?.message}</span>
                </div>
                {/* email input */}
                <div>
                  <input
                    ...
                    {...register('email')}
                  ></input>
                  <span className='pl-3 text-red-500'>{errors.email?.message}</span>
                </div>
                {/* phone input */}
                <div>
                  <input
                    ...
                    {...register('phone')}
                  ></input>
                  <span className='pl-3 text-red-500'>{errors.phone?.message}</span>
                </div>
                {/* message input */}
                <div>
                  <textarea
                    ...
                    {...register('message')}
                  ></textarea>
                  <span className='pl-3 text-red-500'>{errors.message?.message}</span>
                </div>

                <button className="inline-block self-end bg-efferBlue font-bold text-white rounded-lg px-6 py-2 uppercase">
                  Send
                </button>
